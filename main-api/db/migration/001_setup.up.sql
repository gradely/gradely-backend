...
(
    ...
    `oauth_provider`       enum('facebook','google','twitter') CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
    ...
    KEY `phone` (`phone`)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='This holds information of gradely users.';
...
(
    ...
    `category`      enum('all','primary','junior','senior','primary-junior','secondary') CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'all',
    `image`         text CHARACTER SET utf8 COLLATE utf8_unicode_ci COMMENT 'Subject image',
    ...
    `department`    enum('science','commercial','art') COLLATE utf8_unicode_ci DEFAULT NULL,
...
(
    ...
    KEY           `user_account_veriofication_idx` (`user_id`),
    CONSTRAINT `user_account_veriofication` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(
    ...
    `type`           enum('catchup','diagnosis') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'catchup',
    ...
    CONSTRAINT `catchup_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
...
(
    ...
    `difficulty` enum('easy','medium','hard') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'hard',
    `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
...
(
    ...
    `repetition`       enum('once','daily','workdays','weekly') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'once',
    `class`            int                                                             DEFAULT NULL,
    `subject_id`       int                                                             DEFAULT NULL,
    `session_count`    int                                                    NOT NULL DEFAULT '1',
    `curriculum_id`    int                                                             DEFAULT NULL,
    `category`         varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Either paid, covid19 or class',
    ...
    `status`           enum('pending','ongoing','completed','cancelled') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'pending',
    ...
    `payment`          enum('free','paid') COLLATE utf8_unicode_ci DEFAULT NULL,
    `amount`           double(10, 2
                             ) DEFAULT NULL COMMENT 'This is the amount of the service',
    `currency` enum('NGN','USD') COLLATE utf8_unicode_ci DEFAULT NULL,
...
(
    ...
    `establish_date`          varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci           DEFAULT NULL,
    ...
    `school_type`             varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci          DEFAULT NULL,
    `created_at`              timestamp                                               NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at`              timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    `naming_format`           enum('year','ss','montessori') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'year' COMMENT 'SS is primary, junior and senior secondary school naming format. Yeah is for year1 to year12.',
    `timezone`                varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci           DEFAULT NULL,
    `boarding_type`           varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci           DEFAULT NULL,
    `subscription_plan`       varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci           DEFAULT NULL,
    ...
    PRIMARY KEY (`id`),
    KEY                       `user_id` (`user_id`),
    CONSTRAINT `schools_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;

CREATE TABLE IF NOT EXISTS `global_class`
(
    `id`          int                                                    NOT NULL AUTO_INCREMENT,
    `class_id`    varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(
    ...
    `slug`            varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `class_name`      varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'e.g Senior secondary School 1',
    `abbreviation`    varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci  NOT NULL,
    `class_code`      varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci  NOT NULL COMMENT 'e.g HBY/SSS1',
    `created_at`      timestamp                                               NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at`      timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
...
(
    ...
    `previous_content` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
    `new_content`      text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
    `action_name`      varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'e.g create, update, delete',
    `created_at`       timestamp                                               NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
...
(
    ...
    `phone`                varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci           DEFAULT NULL,
    `image`                varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci          DEFAULT NULL,
    `type`                 enum('student','teacher','parent','school') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `auth_key`             varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci  NOT NULL,
    `password_hash`        varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `password_reset_token` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci          DEFAULT NULL,
    `email`                varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `gender`               enum('female','male') CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
    `dob`                  smallint                                                         DEFAULT NULL COMMENT 'day of birth',
    `mob`                  varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci           DEFAULT NULL COMMENT 'month of birth',
...
(
    ...
    `class`       enum('primary','junior','senior') COLLATE utf8_unicode_ci DEFAULT NULL,
    `created_at`  timestamp                                               NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at`  timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lists of exams that has specific subjects';
...
(
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `token_UNIQUE` (`token`),
    KEY               `feed_user_idx` (`user_id`),
    KEY               `feed_global_class_idx` (`global_class_id`),
    CONSTRAINT `feed_ibfk_1` FOREIGN KEY (`global_class_id`) REFERENCES `global_class` (`id`),
    CONSTRAINT `feed_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='This holds the feeds to be seen among all types of user.';
...
(
    ...
    `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY          `feed_comment__user_idx` (`user_id`),
    CONSTRAINT `feed_comment__user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(
    ...
    `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY          `feed_like__user_idx` (`user_id`),
    CONSTRAINT `feed_like__user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Manages the user likes on every post';
...
(
    ...
    `updated_at`       timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='This is activities of videos and other file type. It can be used to monitor opened file, and other user traces';
...
(
    ...
    `access_status`           enum('active','closed') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'active',
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='This homework table will all quiz.';
...
(
    ...
    CONSTRAINT `homework_questions_ibfk_2` FOREIGN KEY (`teacher_id`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT `homework_questions_ibfk_3` FOREIGN KEY (`homework_id`) REFERENCES `homeworks` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `homework_questions_ibfk_4` FOREIGN KEY (`teacher_id`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
...
(
    ...
    `updated_at`  timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY           `homework_selected_student__student_idx` (`student_id`),
    KEY           `homework_selected_student__teacher_idx` (`teacher_id`),
    CONSTRAINT `homework_selected_student__student` FOREIGN KEY (`student_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `homework_selected_student__teacher` FOREIGN KEY (`teacher_id`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='This table is lists of selected student to participate in homework';

CREATE TABLE IF NOT EXISTS `invite_log`
(
    `id`                int                                                     NOT NULL AUTO_INCREMENT,
    `receiver_email`    varchar(100) COLLATE utf8_unicode_ci                             DEFAULT NULL,
    `receiver_name`     varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci          DEFAULT NULL,
    `receiver_type`     varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci  NOT NULL,
    `receiver_phone`    varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci           DEFAULT NULL,
    `receiver_class`    varchar(200) COLLATE utf8_unicode_ci                             DEFAULT NULL,
    `receiver_subject`  int                                                              DEFAULT NULL,
    `receiver_subjects` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci          DEFAULT NULL COMMENT 'Used to invite teacher to multiple subjects',
    `sender_type`       varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci  NOT NULL,
    `sender_id`         int                                                     NOT NULL,
    `sender_school_id`  int                                                              DEFAULT NULL,
    `token`             varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `extra_data`        text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
    `status`            int                                                     NOT NULL DEFAULT '0',
    `created_at`        timestamp                                               NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT;
...
(
    ...
    `updated_at`  timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Learning area is a sub-topics category. Used to breakdown topic into multiple areas';
...
(
    ...
    `inviter`          varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci          DEFAULT NULL,
    `status`           int                                                    NOT NULL DEFAULT '0',
    `role`             varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'guardian',
    `invitation_token` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci          DEFAULT NULL,
    `created_at`       timestamp                                              NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY                `parent_id` (`parent_id`),
    KEY                `student_id` (`student_id`),
    CONSTRAINT `parents_ibfk_1` FOREIGN KEY (`parent_id`) REFERENCES `user` (`id`) ON DELETE CASCADE,
    CONSTRAINT `parents_ibfk_2` FOREIGN KEY (`parent_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `parents_ibfk_3` FOREIGN KEY (`student_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
...
(
    ...
    `authorization_code` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `token_UNIQUE` (`token`),
    KEY              `practice_material_user_idx` (`user_id`),
    CONSTRAINT `practice_material_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='This table holds information of files shared on homework, live class, posts and finds generally';
...
(
    ...
    `type`          enum('reject_submission','admin_report','report_error') CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
    `report`        text CHARACTER SET utf8 COLLATE utf8_unicode_ci COMMENT 'They will be comma separated values. e.g Cheating, Impersonation',
...
(
    ...
    `created_at`      timestamp                                                    NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY               `proctor_report__user_idx` (`student_id`),
    ...
    CONSTRAINT `proctor_report__user` FOREIGN KEY (`student_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='This holds proctor report of assessment';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='This holds assessment monitoring Information of student during practice';
...
(
    ...
    `subject_id`        int       NOT NULL,
    `class_id`          varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
    `school_id`         int                                                    DEFAULT NULL,
    `question`          text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `option_a`          text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
    `option_b`          text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
    `option_c`          text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
    ...
    `is_custom_topic`   int                                                    DEFAULT '0' COMMENT '0 means the topics is from subject_topics, 1 means the question is created while in custom curriculum in school and the topic is from school_topic',
    `created_at`        timestamp NOT NULL                                     DEFAULT CURRENT_TIMESTAMP,
    `year`              varchar(4) COLLATE utf8_unicode_ci                     DEFAULT NULL COMMENT 'Year of an exam',
    `updated_at`        timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
...
(
    ...
    PRIMARY KEY (`id`),
    KEY               `student_id` (`student_id`),
    CONSTRAINT `quiz_summary_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
(
    ...
    `student_id`        int       NOT NULL,
    `question_id`       int       NOT NULL,
    `selected`          text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    ...
    `answer_attachment` text COLLATE utf8_unicode_ci COMMENT 'For essay or any question type that requires you provide attachment',
...
(
    ...
    `updated_at`     timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY              `recommendations__user_idx` (`student_id`),
    CONSTRAINT `recommendations__user` FOREIGN KEY (`student_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='This is a periodic recommendation generated to students';
...
(
    ...
    `created_at`        timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY                 `recommendation_topics__user_idx` (`student_id`),
    ...
    CONSTRAINT `recommendation_topics__user` FOREIGN KEY (`student_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(
    `id`          int       NOT NULL AUTO_INCREMENT,
    `type`        enum('homework','student') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(
    ...
    `description`  text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
    `type`         enum('question','feed','comment') COLLATE utf8_unicode_ci DEFAULT NULL,
    `status`       int       NOT NULL                                      DEFAULT '1',
...
(
    ...
    `created_at`  timestamp NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY           `request_call__user_id_idx` (`user_id`),
    CONSTRAINT `request_call__user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(
    ...
    `created_at`         timestamp NOT NULL                                           DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY                  `reveiver_id__user_idx` (`receiver_id`),
    KEY                  `sender_id__ user_idx` (`sender_id`),
    CONSTRAINT `reveiver_id__user` FOREIGN KEY (`receiver_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `sender_id__ user` FOREIGN KEY (`sender_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(
    ...
    KEY          `user_id` (`user_id`),
    KEY          `school_id` (`school_id`),
    CONSTRAINT `school_admin_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `school_admin_ibfk_2` FOREIGN KEY (`school_id`) REFERENCES `schools` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `school_admin_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
(
    `id`                int                                                     NOT NULL AUTO_INCREMENT,
    `school_id`         int                                                     NOT NULL,
    `session_name`      varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(
    `id`           int       NOT NULL AUTO_INCREMENT,
    `school_id`    int       NOT NULL,
    `class_naming` enum('jss','year') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `created_at`   timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY            `school_id` (`school_id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='This is to lists the roles of school access';
...
(
    ...
    CONSTRAINT `school_teachers_ibfk_3` FOREIGN KEY (`teacher_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT;
...
(
    ...
    `class_range` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `status`      int                                                    NOT NULL DEFAULT '1',
    `created_at`  timestamp                                              NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
...
(
    ...
    CONSTRAINT `security_question_answer_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE,
...
(
    ...
    `short_token` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `click_count` int                                                     NOT NULL DEFAULT '0',
    `last_click`  datetime                                                         DEFAULT NULL,
    `description` text CHARACTER SET utf8 COLLATE utf8_unicode_ci COMMENT 'describe what the link is going if it is general link',
    `status`      int                                                     NOT NULL DEFAULT '1',
    `created_at`  timestamp                                               NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
...
(
    ...
    CONSTRAINT `student_additiional_topics__updater` FOREIGN KEY (`updated_by`) REFERENCES `user` (`id`),
    CONSTRAINT `student_additiional_topics__user` FOREIGN KEY (`student_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(
    ...
    PRIMARY KEY (`id`),
    KEY          `student_exam_config__user_id_idx` (`student_id`),
    CONSTRAINT `student_exam_config__user_id` FOREIGN KEY (`student_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(
    ...
    `school_id`             int                                                    DEFAULT NULL,
    `class_id`              int                                                    DEFAULT NULL,
    `invite_code`           varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
    `status`                int       NOT NULL                                     DEFAULT '0',
    ...
    `subscription_status`   enum('basic','premium') COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Basic is lms, premium is lms with catchup',
    ...
    `session`               varchar(50) COLLATE utf8_unicode_ci                    DEFAULT NULL COMMENT 'Session of the student',
    `in_summer_school`      tinyint                                                DEFAULT NULL COMMENT '1 if the child is in summer school and 0 if not. Default is 0.',
    `summer_payment_status` enum('unpaid','paid') COLLATE utf8_unicode_ci DEFAULT NULL,
    `created_at`            timestamp NOT NULL                                     DEFAULT CURRENT_TIMESTAMP,
    `updated_at`            timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY                     `school_id` (`school_id`),
    KEY                     `student_id` (`student_id`),
    KEY                     `class_id` (`class_id`),
    KEY                     `student_school__promoter_idx` (`promoted_by`),
    CONSTRAINT `student_school__promoter` FOREIGN KEY (`promoted_by`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `student_school_ibfk_1` FOREIGN KEY (`school_id`) REFERENCES `schools` (`id`) ON DELETE CASCADE,
    CONSTRAINT `student_school_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `user` (`id`) ON DELETE CASCADE,
...
(
    ...
    `coupon`             varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci        DEFAULT NULL COMMENT 'If coupon provided',
...
(
    ...
    `student_id`      int       NOT NULL,
    `payment_status`  enum('unpaid','paid') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'unpaid',
...
(
    ...
    `user_id`            int                                                     NOT NULL,
    `email`              varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `customer_code`      varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci          DEFAULT NULL,
    `selected`           int                                                     NOT NULL DEFAULT '0',
    `payment_channel`    varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'paystack',
    `authorization_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `bin`                varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `last4`              varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `exp_month`          varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `exp_year`           varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `channel`            varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `card_type`          varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `bank`               varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `country_code`       varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(
    ...
    `plan`           enum('basic','premium') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'e.g basic, premium, etc',
    `duration`       enum('month','year') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(
    ...
    CONSTRAINT `teacher_class_ibfk_6` FOREIGN KEY (`teacher_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
(
    ...
    KEY          `class_id` (`class_id`),
    KEY          `school_id` (`school_id`),
    CONSTRAINT `teacher_class_subjects_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `user` (`id`) ON DELETE CASCADE,
    ...
    CONSTRAINT `teacher_class_subjects_ibfk_6` FOREIGN KEY (`teacher_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
(
    ...
    `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY          `tutor_availability__user_idx` (`user_id`),
    CONSTRAINT `tutor_availability__user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(
    ...
    PRIMARY KEY (`id`),
    KEY                  `tutor_id__user_idx` (`tutor_id`),
    CONSTRAINT `profile_tutor_id__user` FOREIGN KEY (`tutor_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(
    ...
    PRIMARY KEY (`id`),
    KEY             `tutor_id__user_idx` (`tutor_id`),
    CONSTRAINT `tutor_id__user` FOREIGN KEY (`tutor_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(
    ...
    PRIMARY KEY (`id`),
    KEY                        `user_references__user_idx` (`user_id`),
    CONSTRAINT `user_references__user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(
    ...
    `state`                     varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
    `country`                   varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
    `about`                     mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
    `postal_code`               varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci  DEFAULT NULL,
    ...
    `password_updated_location` varchar(100) COLLATE utf8_unicode_ci                    DEFAULT NULL,
    `password_updated_device`   varchar(255) COLLATE utf8_unicode_ci                    DEFAULT NULL,
    `signup_source`             varchar(100) COLLATE utf8_unicode_ci                    DEFAULT NULL,
    ...
    CONSTRAINT `user_profile_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
...
(
    ...
    `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='To determine if the user account type can access certain application';
